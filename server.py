...
def build_receipt_pdf(session: Session) -> bytes:
    ...
    canvas.drawString(48, height - 58, "Beacon Plan Receipt")
    canvas.setFont("Helvetica", 10)
    canvas.drawString(48, height - 78, "Confirmed plan - no external booking or purchase was made")
    y = height - 145
    canvas.setFillColor(navy)
    ...
    canvas.setFont("Helvetica", 10)
    for line in wrap("Goal: " + session.goal, width=85):
    ...
    canvas.drawString(48, y, "Plan details")
    y -= 22
    canvas.setFont("Helvetica", 10)
    for key, value in receipt.items():
        ...
        canvas.setFillColor(navy)
        canvas.drawString(185, y, str(value))
        y -= 19
    y -= 6
    canvas.setFillColor(navy)
    canvas.setFont("Helvetica-Bold", 12)
    ...
    y -= 21
    canvas.setFont("Helvetica", 10)
    for step in ("Review this approach with anyone involved.",
    ...
    canvas.drawRightString(width - 48, 42, "Plan receipt - not a booking")
    canvas.save()
